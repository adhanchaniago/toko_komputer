...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="add-tb" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo base_url('admin/add_katagori')?>" method="post" enctype="multipart/form-data" role="form">
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit-data" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
                <h4 class="modal-title">Ganti Katagori</h4>
            </div>
            <form class="form-horizontal" action="<?php echo base_url('admin/edit_katagori')?>" method="post" enctype="multipart/form-data" role="form">
                <div class="modal-body">
                        <div class="form-group">
                            <label class="col-lg-2 col-sm-2 control-label">Katagori</label>
                            <div class="col-lg-10">
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="delete-data" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo base_url('admin/delete_katagori')?>" method="post" enctype="multipart/form-data" role="form">
                <div class="modal-body">
                        <div class="form-group">
                           <label class="col-lg-4 col-sm-4 control-label">Nama Katagori</label>
                            <div class="col-lg-8">
                                <input type="hidden" id="id" name="id">
                                <input type="text" name="nama_katagori" id="nama_katagori" class="form-control" readonly>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href                 ="javascript:;"
                                   ...
                                   data-nama_katagori   ="<?php echo $row->nama_katagori ?>"
                                   data-toggle          ="modal"
...
<script>
    $(document).ready(function() {
        ...
        $('#edit-data').on('show.bs.modal', function (event) {
            ...
            modal.find('#nama_katagori').attr("value",div.data('nama_katagori'));
